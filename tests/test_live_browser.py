...
def main():
    ...
    try:
        ...
        assert "V002.6.0" in title, f"Title does not contain V002.6.0: {title}"
        assert version_tag == "V002.6.0", f"Version tag is not V002.6.0: {version_tag}"
        assert config_version == "V002.6.0", f"CONFIG_VERSION is not V002.6.0: {config_version}"
