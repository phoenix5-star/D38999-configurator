...
public class DisassemblerWorkObj {
...
$type = [SkyCadKernel.SkyCadWorkObject]
[DisassemblerWorkObj]::PrintMethod($type.GetMethod("GetPropertyByDefinition", [System.Reflection.BindingFlags]"Public,NonPublic,Instance"))
[DisassemblerWorkObj]::PrintMethod($type.GetMethod("GetPropertyByName", [System.Reflection.BindingFlags]"Public,NonPublic,Instance"))
