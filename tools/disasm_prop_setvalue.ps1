...
[Disassembler2]::PrintMethod($pType.GetMethod("SaveToFile", [System.Reflection.BindingFlags]"Public,NonPublic,Instance"))
[Disassembler2]::PrintMethod($pType.GetMethod("ReadBasicValuesFromObject", [System.Reflection.BindingFlags]"Public,NonPublic,Instance"))
