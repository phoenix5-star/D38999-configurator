...
$pType = [SkyCadKernel.SkyCadProperty]
[Disassembler4]::PrintMethod($pType.GetMethod("LoadFromStream", [System.Reflection.BindingFlags]"Public,NonPublic,Instance,DeclaredOnly"))
[Disassembler4]::PrintMethod($pType.GetMethod("ProcessReferencesAfterLoad", [System.Reflection.BindingFlags]"Public,NonPublic,Instance,DeclaredOnly"))
