...
$oType = [SkyCadKernel.SkyCadObject]
[Disassembler3]::PrintMethod($oType.GetMethod("SaveToFile", [System.Reflection.BindingFlags]"Public,NonPublic,Instance,DeclaredOnly"))
$boType = [SkyCadKernel.SkyCadBaseObject]
[Disassembler3]::PrintMethod($boType.GetMethod("SaveToFile", [System.Reflection.BindingFlags]"Public,NonPublic,Instance,DeclaredOnly"))
